...
function ContentGetApp() {
  return (
    <div className="h-full font-poppins bg-[url('/images/get-app/background-small.svg')] md:bg-[url('/images/get-app/background.svg')] bg-no-repeat sm:bg-cover bg-center bg-fixed flex items-center justify-center">
      <div className="flex flex-col items-center justify-center py-16 px-9 h-fit text-center">
        <h1 className="text-5xl font-bold text-[#002c6e] mb-5 mt-14">
          Get The Paywave App
        </h1>
        ...
        <div className="flex justify-center space-x-3 w-full">
          <input
            ...
            className="w-3/4 px-4 py-2 bg-[#DCEAFF] rounded-full focus:outline-none ease-in focus:scale-105 placeholder:text-[#002C6E]"
          />
