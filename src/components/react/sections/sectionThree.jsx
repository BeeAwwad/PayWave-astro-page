...
function sectionThree() {
  ...
  return (
    <>
      ...
      <div className="bg-[#002C6E] font-poppins p-10 mt-9 md:mx-16 xl:mx-48 md:rounded-2xl h-[620px] pt-32">
        ...
        <div className="relative mt-20">
          <img
            className="absolute top-0 left-[-3.125rem] sm:left-0 size-40 sm:size-48 z-50"
            src="/images/section/section-3/section-3-instant.svg"
            alt="instant-payment"
          />
          <div className="qr-code size-12 top-24 right-1 sm:size-20 sm:top-32 sm:right-20 z-30 md:right-10"></div>
          <img
          ...
          />
          <img
            className="absolute top-44 right-[-2.5rem] sm:size-72 sm:right-10 sm:top-52 md:right-0 z-50 lg:right-[15%]"
